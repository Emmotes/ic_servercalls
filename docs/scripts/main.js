...
async function displayFormationSaves(wrapper,saves) {
	...
	formsDeleter.innerHTML = `<span class="menuRow"><span class="menuCol1" style="width:50%" id="formationsDeleteRow"><input type="button" onClick="deleteFormationSaves()" name="formationsDeleteButton" id="formationsDeleteButton" style="font-size:0.9em" value="Delete Selected Formations"></span></span>`;
}
