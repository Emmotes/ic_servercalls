const vet = 1.101; // prettier-ignore
...
function et_buildSVG(tier, month, day) {
	...
	if (month === 3 && day >= 10 && day <= 18)
		return `<svg width="30" height="30" viewBox="-3 -1 41 41" xmlns="http://www.w3.org/2000/svg" stroke="#000" stroke-width=".35"><path class="svgEventTier${tier}" style="filter:drop-shadow(0px 0px 3px)" d="M32.34 20.208c.198-1.475 2.669-2.208 2.669-4.542S29.25 9.25 21 17c3.812-5.312 6.542-14.509 2.203-14.509-1.47 0-2.579 1.342-4.328 1.342C16.5 3.833 16.208 1 14 1c-2.583 0-5 6.25 1 15-1.5-1.625-11.083-6.625-13.002-1.269-.628 1.753 1.731 2.781 1.544 4.519-.178 1.654-2.597 2.037-2.597 4.372 0 3.293 8.048 4.834 16.044-1.613-.245 4.524.557 10.515 3.857 14.158 1.344 1.483 2.407.551 2.822.187s1.604-1.414.185-2.822c-3.834-3.807-5.225-8.174-5.619-11.381 2.043 2.215 12.357 8.742 15.517 2.767.881-1.668-1.643-2.977-1.411-4.71z"/></svg>`;
	if (month === 8 && day >= 1 && day <= 9)
